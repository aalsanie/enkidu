...
/**
 * Normalized kind of a classpath entry.
 *
 * The core model uses [ClasspathEntry] as a sealed hierarchy; this enum exists to support
 * stable reporting/evidence without leaking concrete subtypes into other layers.
 */
enum class ClasspathEntryKind {
    DIRECTORY,
    JAR,
}
